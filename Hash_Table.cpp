...
public:
    ...
    //     if (flag == 1)
    //     {
    //         cout << "\nClient details found at:" << i << "\n"
    //              << "Name of client is: " << HT[i].Name
    //              << "\n"
    //              << "Number of client is: " << HT[i].Number;
    //     }
    //     else
    //     {
    //         cout << "\n Client id not found";
...
//         probe_number = -1;
//     }
//     Client(int Client_id, string Client_Name, long long int Client_Number, int Client_Probe)
//     {
//         Client_id = id;
//         Client_Name = Name;
//         Client_Number = Number;
//         Client_Probe = probe_number;
//     }
//     void getdata()
//     {
...
//             cout << "\n"
//                  << i << "\t" << HT[i].id << "\t" << HT[i].Name << "\t" << HT[i].Number;
//         }
...
//         if (HT[index].probe_number == -1)
//         {
//             cout << "No collision" << endl;
//             HT[index] = c;
//             HT[index].probe_number = index + 1;
//         }
//         else
//         {
//             cout << "Collision occured" << endl;
//             int i = index;
//             while (HT[i].probe_number != -1)
//             {
//                 i = HT[i].probe_number;
//             }
//             HT[i] = c;
//             HT[i].probe_number = i + 1;
//         }
//     }
// };
// int main()
